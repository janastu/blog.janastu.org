...
we need less heavy images. reduce size? if you add new images or edits. Please put XXX so its easy to find. This is already pushed to blog.janastu.org (github.com/janastu/blog.janastu.org/_posts) [and yes we have ot talked about the loop problem]
And lets add photos of build team at the bottom: **Rama, Manjamma, all**
